...
public class ListZakatMasuk extends RecyclerView.Adapter<ListZakatMasuk.HolderData> {
    private List<RequestResponse> listrequestzakat ;
    private Activity activity;

    public ListZakatMasuk(List<RequestResponse> listrequestzakat, Activity activity) {
    ...
    public void onBindViewHolder(@NonNull HolderData holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(activity, InfoPengambilanAdminActivity.class);
                i.putExtra("tvid", dm.getIdRequest());
                i.putExtra("tvidAmil", dm.getIdAmil());
