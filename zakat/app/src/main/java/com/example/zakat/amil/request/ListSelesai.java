...
public class ListSelesai extends RecyclerView.Adapter<ListSelesai.HolderData> {
    private List<RequestResponse> listrequestzakat ;
    private Fragment fragment;

    public ListSelesai(List<RequestResponse> listrequestzakat, Fragment fragment) {
