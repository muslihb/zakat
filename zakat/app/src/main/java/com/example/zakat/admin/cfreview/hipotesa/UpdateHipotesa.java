...
public class UpdateHipotesa extends DialogFragment{
    TextInputLayout textInputLayoutkode, textInputLayoutquest, textInputLayoutifyes, textInputLayoutifno;
    TextInputEditText etkode, etnama, etquest,etifyes, etifno;
    String kodehipotesa, nama;

    public UpdateHipotesa(String kodehipotesa, String nama) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        textInputLayoutkode.setHint("Kode Hipotesa");
        etkode.setText(kodehipotesa);
        etnama.setText(nama);
    ...
    private void update() {
        ...
        Call<ResponseData> registerData = apiAdapter.updatehipotesa(etkode.getText().toString()
        ...
        registerData.enqueue(new Callback<ResponseData>() {
            ...
            public void onResponse(Call<ResponseData> call, Response<ResponseData> response) {
                ...
                if (!kode.equals("0")){
                    ...
                    ((HipotesaActivity) getActivity()).retrievekonklusiData();
                    dismiss();
                }else {
                    Toast.makeText(getActivity(), pesan, Toast.LENGTH_SHORT).show();
                }
