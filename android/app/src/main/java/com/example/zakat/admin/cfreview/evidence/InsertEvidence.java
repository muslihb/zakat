...
public class InsertEvidence extends DialogFragment {
    ...
    private void simpandata() {
        ...
        Call<ResponseData> registerData = apiAdapter.insertevidencepenilaian(etkode.getText().toString(),etnama.getText().toString(),
