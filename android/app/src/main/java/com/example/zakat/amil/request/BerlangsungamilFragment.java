...
public class BerlangsungamilFragment extends Fragment {
    ...
    String statusnow = "Berlangsung";
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_berlangsung_amil, container, false);
    ...
    public void retrieveDataBerlangsung() {
...
//                    Toast.makeText(getActivity(), "Kode : " +kode+" | Pesan : " +pesan, Toast.LENGTH_SHORT).show();
                    ...
                    adData = new ListBerlangsung(listrequestzakat, BerlangsungamilFragment.this);
