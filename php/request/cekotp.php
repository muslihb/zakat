...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $otp = $_POST["otp"];
    $perintah = "SELECT * FROM tbrequestzakat where id_request = '$id_request' and id_amil = '$id_amil' and statuspengambilan = '$statuspengambilan' and otp = '$otp'";
    ...
    if ($cek > 0) {
        ...
        $response["kode"] = 0;
        $response["pesan"] = "OTP Tidak Valid";
    }
} else {
    $response["kode"] = 0;
