...
if($_SERVER['REQUEST_METHOD'] =='POST'){
   ...
   $perintah = "SELECT * FROM tbrequestzakat WHERE statuspengambilan = '$statuspengambilan' ORDER by tgl_request DESC";
...
// $perintah = "SELECT * FROM tbrequestzakat order by id_request DESC";
// $execute = mysqli_query($conn, $perintah);
// $cek = mysqli_affected_rows($conn);
// if($cek > 0){
//     $response["kode"] = 1;
